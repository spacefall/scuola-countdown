...
const vacanzeVeneto = {
  ...
  9: [],
  10: [1, 2],
  11: [8, 23, 24, 25, 26, 27, 28, 29, 30, 31],
};

// Data finale
const countdownDate = new Date("Jun 7, 2025 13:15:00");
...
var countdown = setInterval(function () {
  ...
  document.getElementById("countdown_lavorativi").innerHTML =
    days -
    daysAntiLavorativi +
    "d " +
    hours +
...
var countdownXmas = setInterval(function () {
  ...
  // Find the distance between now and the count down date
  var distance = countdownDateXmas.getTime() - now.getTime();
  ...
  // Imposta il testo di countdown_lavorativi
  document.getElementById("countdown_lavorativi_natale").innerHTML =
    days -
    daysAntiLavorativi +
    "d " +
    hours +
  ...
  // Imposta il testo di countdown
  document.getElementById("countdown_natale").innerHTML =
    days + "d " + hours + "h " + minutes + "m " + seconds + "s ";

  // Se il countdown ha finito scrivi vacanza
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("countdown_natale").innerHTML = "Natale 🎅";
    document.getElementById("countdown_lavorativi_natale").innerHTML =
      "Natale 🎅";
  }
}, 1000);
